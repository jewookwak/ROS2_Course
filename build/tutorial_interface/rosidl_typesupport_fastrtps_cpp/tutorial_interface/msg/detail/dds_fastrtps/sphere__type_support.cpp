...
#include "tutorial_interface/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tutorial_interface::msg::Sphere;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tutorial_interface::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutorial_interface::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &tutorial_interface::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
