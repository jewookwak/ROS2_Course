...
bool ros2_interfaces_tutorial__msg__sphere__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_interfaces_tutorial.msg._sphere.Sphere", full_classname_dest, 43) == 0);
  }
  ros2_interfaces_tutorial__msg__Sphere * ros_message = _ros_message;
  {  // center
...
PyObject * ros2_interfaces_tutorial__msg__sphere__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_interfaces_tutorial.msg._sphere");
