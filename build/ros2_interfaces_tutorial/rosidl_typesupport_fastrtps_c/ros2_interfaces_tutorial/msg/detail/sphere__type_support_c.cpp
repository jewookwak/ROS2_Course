...
#include "ros2_interfaces_tutorial/msg/detail/sphere__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_ros2_interfaces_tutorial
...
using _Sphere__ros_msg_type = ros2_interfaces_tutorial__msg__Sphere;
...
static uint32_t _Sphere__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_interfaces_tutorial__msg__Sphere(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interfaces_tutorial__msg__Sphere;
    is_plain =
      (
...
static size_t _Sphere__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_interfaces_tutorial__msg__Sphere(
