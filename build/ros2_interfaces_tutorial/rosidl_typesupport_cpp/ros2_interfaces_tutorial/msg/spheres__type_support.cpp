...
static const _Spheres_type_support_symbol_names_t _Spheres_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_interfaces_tutorial, msg, Spheres)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_interfaces_tutorial, msg, Spheres)),
  }
};
...
{
  return &::ros2_interfaces_tutorial::msg::rosidl_typesupport_cpp::Spheres_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_interfaces_tutorial, msg, Spheres)() {
  return get_message_type_support_handle<ros2_interfaces_tutorial::msg::Spheres>();
}
