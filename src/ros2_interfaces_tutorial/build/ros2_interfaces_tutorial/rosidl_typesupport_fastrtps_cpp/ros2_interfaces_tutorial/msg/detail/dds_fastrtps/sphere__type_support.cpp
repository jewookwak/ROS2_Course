...
#include "ros2_interfaces_tutorial/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_interfaces_tutorial::msg::Sphere;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_interfaces_tutorial::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_interfaces_tutorial::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &ros2_interfaces_tutorial::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
