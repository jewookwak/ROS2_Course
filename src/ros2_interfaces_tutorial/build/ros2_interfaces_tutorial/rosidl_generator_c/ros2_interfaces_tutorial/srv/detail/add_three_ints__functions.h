...
#ifndef ROS2_INTERFACES_TUTORIAL__SRV__DETAIL__ADD_THREE_INTS__FUNCTIONS_H_
#define ROS2_INTERFACES_TUTORIAL__SRV__DETAIL__ADD_THREE_INTS__FUNCTIONS_H_
 ...
 * calls
 * ros2_interfaces_tutorial__srv__AddThreeInts_Request__init().
...
/**
 * It calls
 * ros2_interfaces_tutorial__srv__AddThreeInts_Request__fini()
 ...
 * ros2_interfaces_tutorial__srv__AddThreeInts_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * ros2_interfaces_tutorial__srv__AddThreeInts_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ros2_interfaces_tutorial__srv__AddThreeInts_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2_interfaces_tutorial
...
/**
 * It calls
 * ros2_interfaces_tutorial__srv__AddThreeInts_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2_interfaces_tutorial
...
/**
 * It allocates the memory for the array and calls
 * ros2_interfaces_tutorial__srv__AddThreeInts_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2_interfaces_tutorial
...
/**
 * It calls
 * ros2_interfaces_tutorial__srv__AddThreeInts_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROS2_INTERFACES_TUTORIAL__SRV__DETAIL__ADD_THREE_INTS__FUNCTIONS_H_
