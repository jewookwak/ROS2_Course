...
class Metaclass_AddThreeInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_interfaces_tutorial.srv.AddThreeInts')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from ros2_interfaces_tutorial.srv import _add_three_ints
...
class AddThreeInts(metaclass=Metaclass_AddThreeInts):
    from ros2_interfaces_tutorial.srv._add_three_ints import AddThreeInts_Request as Request
    from ros2_interfaces_tutorial.srv._add_three_ints import AddThreeInts_Response as Response
