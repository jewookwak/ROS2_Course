...
def generate_launch_description():
    ...
    # 런치 파라미터 선언
    alpha_arg = DeclareLaunchArgument('alpha', default_value='1.0', description='Alpha parameter')
    beta_arg = DeclareLaunchArgument('beta', default_value='20.0', description='Beta parameter')
    influence_distance_arg = DeclareLaunchArgument('influence_distance', default_value='1.0', description='Influence distance')
